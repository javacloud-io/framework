...
public final class BlindTrustProvider extends java.security.Provider {
	...
	public static final	BlindHostnameVerifier HOSTNAME_VERIFIER = new BlindHostnameVerifier();
	...
	static final class BlindHostnameVerifier implements HostnameVerifier {
		@Override
