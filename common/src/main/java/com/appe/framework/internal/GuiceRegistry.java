 ...
 *
 */
public class GuiceRegistry extends AppeRegistry {
	...
	protected Injector createInjector() {
		return GuiceFactory.createInjector(new GuiceBuilder.StageBuilder(Stage.PRODUCTION), "META-INF/registry-services.guice", AppeLoader.getClassLoader());
	}
}
